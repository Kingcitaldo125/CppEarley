...
std::vector<std::string> Earley::split(const std::string& strng, const char delim)
{
...
bool Earley::predict(S_type_t& S, const unsigned int k, const std::string& nxt_elem, S_grammar_type_t& grammar)
{
	bool added = false;
...
bool Earley::scan(S_type_t& S, const unsigned int k, S_state_type_t& state, const std::string& words)
{
	bool added = false;
...
bool Earley::complete(S_type_t& S, const unsigned int k, S_state_type_t& state)
{
	bool added = false;
